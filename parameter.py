...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        # INPUT PATH
        dataset_dir='/home2/dataset/dataset/Dcase-2021-Dataset',  # Base folder containing the foa_dev/mic_dev and metadata folders

        # OUTPUT PATH
        feat_label_dir='/home3/sunXH/dcase2021/feat_label/',  # Directory to dump extracted features and labels
        model_dir='/home3/sunXH/dcase2021/models/',            # Dumps the trained models and training curves in this folder
        dcase_output_dir='/home3/sunXH/dcase2021/result/',    # recording-wise results are dumped in this path.
